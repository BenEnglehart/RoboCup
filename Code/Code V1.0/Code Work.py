...
def op_point_val_check(x, y):
    ...
    val = point_vals[arr[x]*7 + arr[field_bounds[2] + y]]       # Identify the correct position in the "value" array
...
#             if n == 0 and op_point_val_check(i, j) > (al_n - 1):
#                 top_loc_values[n] = op_point_val_check(i, j)
#                 n = n+1
#             elif n == al_n * 2-1:
#                 for k in range(al_n * 2):
#                     prox = point_prox(pos[i], pos[j], [0, k*2, k*2+1])
#                     if
# *******************************************
...
# GENERAL VARIABLES:
pxl_size = (600, 600)                           # Pixel size of camera view
