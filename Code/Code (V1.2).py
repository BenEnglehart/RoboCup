...
def pxl_2_grid():
    ...
    for i in range(rob_num+1):
        dummy_arr = []      # Initiate dummy arr for appending
        dummy_arr[0] = coords_arr[i][0]
        # Insert Modulus Code::: %
        dummy_arr[1] = coords_arr[i][1]/pxl_grd_ratio[0]

        # Insert Modulus Code::: %
        dummy_arr[2] = coords_arr[i][2]/pxl_grd_ratio[1]
